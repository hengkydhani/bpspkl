...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2016 at 06:19 AM
...
CREATE TABLE IF NOT EXISTS `sk-hakakses` (
...
CREATE TABLE IF NOT EXISTS `sk-hakakses-wilayah` (
  ...
  `user_create` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_Provinsi`,`id_Kabkot`,`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `sk-kabkot`
--

CREATE TABLE IF NOT EXISTS `sk-kabkot` (
  `id_Kabkot` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `id_Provinsi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `sk-kabkot`
--

INSERT INTO `sk-kabkot` (`id_Kabkot`, `id_Provinsi`, `nama_Kabkot`) VALUES
...
CREATE TABLE IF NOT EXISTS `sk-pemutakhiran` (
  `id_Provinsi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_Kabkot` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `user_create` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_Provinsi`,`id_Kabkot`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `sk-pemutakhiran-hist` (
  `id_Provinsi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_Kabkot` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `Jumlah` int(11) NOT NULL,
  `target` int(11) NOT NULL,
  ...
  `user_create` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_Provinsi`,`id_Kabkot`,`tgl_create`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `sk-pemutakhiran-histgl` (
  `id_Provinsi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `id_Kabkot` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `Jumlah` int(11) NOT NULL,
  `target` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sk-provinsi` (
  `id_Provinsi` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
...
('SK', 'Survey Kesehatan', '2016-08-27', '2016-09-20', 0, '2016', '2016-08-26 04:03:50', '2016-08-26 04:03:50', 'alvian', 'alvian');
...
CREATE TABLE IF NOT EXISTS `tahapansurvey` (
  ...
  `user_create` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_tahapan`,`id_survey`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'SK', 'Pemutakhiran', '2016-08-27', '2016-08-31', '2016-08-26 04:03:50', '2016-08-26 04:03:50', 'alvian', 'alvian');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  UNIQUE KEY `users_nip_user_unique` (`nip_user`)
...
INSERT INTO `users` (`id_user`, `name`, `username`, `nip_user`, `level_user`, `avatar`, `remember_token`, `tgl_create`, `tgl_update`) VALUES
(1, 'Andy Eka Saputra', 'aneksa', '123123', 1, 'anonymous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04'),
(2, 'Alvian', 'alvian', '111111', 1, 'anonymous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04'),
(3, 'Hengky', 'hengky', '222222', 2, 'anonysmous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04'),
(4, 'Kamal', 'kamal', '333333', 2, 'anonymous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04'),
(5, 'Eka', 'dyetra', '444444', 2, 'anonymous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04'),
(6, 'Supriadi', 'Supriadi', '555555', 2, 'anonymous.jpg', NULL, '2016-08-26 04:02:04', '2016-08-26 04:02:04');
...
CREATE TABLE IF NOT EXISTS `wilayah` (
  ...
  `user_create` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_wilayah`,`id_survey`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'SK', 'Provinsi', 'SK-Provinsi', '2016-08-26 04:03:50', '2016-08-26 04:03:50', 'alvian', 'alvian'),
(2, 'SK', 'Kabkot', 'SK-Kabkot', '2016-08-26 04:03:50', '2016-08-26 04:03:50', 'alvian', 'alvian');
